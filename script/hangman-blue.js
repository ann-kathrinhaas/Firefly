...
const sentencesToGuess = [
    "Das Passwort fuers Leben heißt Humor.",
    "Besoffen ist auch nur die Abkuerzung fuer besonders offen.",
    ...
    "Ich sage immer die Wahrheit, außer wenn ich luege.",
...
function markIncorrectLetter(letter) {
    ...
    if (!sentenceArray.includes(letter)) {
        ...
        if (hangmanImageIndex <= maxImageIndex) {
            hangmanImage.src = `../../img/hangman-blue/hangman${hangmanImageIndex}.png`;
        }
    }
    ...
    if (remainingTries <= 0) { // Prüfen, ob alle Versuche aufgebraucht sind
        ...
        tryAgainText.style.display = 'block';
        hangmanImage.src = `../../img/hangman-blue/hangman${hangmanImageIndex}.png`; // Aktualisieren des Bilds auf das letzte Hangman-Bild
